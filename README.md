# WatermarkForJYN
为[WzserJYNX](https://space.bilibili.com/1677335724)准备的java版水印数据包
...
例如`title @a actionbar {"text":"Example"}`其中的`Example`可被修改。默认的文本是`bilibili@WzserJYNX 严禁随意转载`，显示效果如图

<img width="404" height="158" alt="image" src="https://github.com/user-attachments/assets/db47d2c4-14d0-4def-93b9-c5158de6e1e0" />
...
# 下载
只需在[Releases](https://github.com/gdxuwjwg/WatermarkForJYN/releases)下载最新版本，版本号会随着数据包版本而变化，里面会说明是为哪个版本及其以前的版本准备的。然后按照数据包的安装方法安装即可
